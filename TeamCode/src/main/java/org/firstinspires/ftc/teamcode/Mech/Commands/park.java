...
public class park extends CommandBase {
    ...
    public void initialize() {
        ...
        if ((zone==2) || (zone==0)) ChassisSub.moveTo(new Pose2d(-26, 2, Math.toRadians(0)));
        else if(zone == 1) ChassisSub.moveTo(new Pose2d(-26, 2, Math.toRadians(0)), new Pose2d(-26, -26, Math.toRadians(0)));
        else if(zone == 3) ChassisSub.moveTo(new Pose2d(-26, 2, Math.toRadians(0)), new Pose2d(-26, 22, Math.toRadians(0))); }
        else{
            if ((zone==2) || (zone==0)) ChassisSub.moveTo(new Pose2d(-26, -2, Math.toRadians(0)));
            else if(zone == 1) ChassisSub.moveTo(new Pose2d(-26, -2, Math.toRadians(0)), new Pose2d(-26, -26, Math.toRadians(0)));
            else if(zone == 3) ChassisSub.moveTo(new Pose2d(-26, -2, Math.toRadians(0)), new Pose2d(-26, 22, Math.toRadians(0)));
