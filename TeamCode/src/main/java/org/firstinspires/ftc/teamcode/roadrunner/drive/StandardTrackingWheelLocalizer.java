...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 4.41; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 5.07; // in; offset of the lateral wheel
