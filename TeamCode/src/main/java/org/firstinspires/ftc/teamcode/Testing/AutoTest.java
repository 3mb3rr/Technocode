        ...
        while (!isStopRequested()) {
            ...
            if (timer.milliseconds() < 27500) {
                if (ChassisSub.pushed() && (ChassisSub.chassisState == ChassisSubsystem.chassis.holding)) {
                    ...
                    CommandScheduler.getInstance().schedule(true, new SequentialCommandGroup(new dropperGrab(DepositSub), new hSlideRetract(hSlideSub), new ParallelCommandGroup(new ttTurnMiddle(DepositSub), new hSlideClose(hSlideSub), new vSlideClose(vSlideSub), new tArmDrop(IntakeSub)), new chassisRetreat(ChassisSub),
                ...
                if ((ChassisSub.chassisState == ChassisSubsystem.chassis.parking) || (ChassisSub.chassisState == ChassisSubsystem.chassis.parked)) {
                    ...
                    CommandScheduler.getInstance().cancelAll();
                    CommandScheduler.getInstance().schedule(new SequentialCommandGroup( new InstantCommand(() -> {ChassisSub.chassisState = ChassisSubsystem.chassis.parking;}),
                            new dropperGrab(DepositSub), new hSlideClose(hSlideSub), new ParallelCommandGroup(new ttTurnMiddle(DepositSub), new vSlideClose(vSlideSub), new tArmDrop(IntakeSub)), new park(ChassisSub, camera.parkingZone)));
                }
            }
